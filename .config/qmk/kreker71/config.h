...
// Uncomment and set to define the number of combo key entries for advanced key combinations.
...
// Enables RGB lighting animations and sets the number of LEDs per half.
#    undef RGBLIGHT_LED_COUNT
#    define RGBLIGHT_ANIMATIONS
#    define RGBLIGHT_LED_COUNT 54

// Configures RGB split lighting between the keyboard halves.
#    undef RGBLED_SPLIT
#    define RGBLED_SPLIT \
        { 27, 27 } // 27 LEDs per half.

// Sets limits for RGB lighting brightness and color adjustments.
#    define RGBLIGHT_LIMIT_VAL 120 // Maximum brightness value.
#    define RGBLIGHT_HUE_STEP  10  // Step size for hue adjustments.
#    define RGBLIGHT_SAT_STEP  17  // Step size for saturation adjustments.
#    define RGBLIGHT_VAL_STEP  17  // Step size for value (brightness) adjustments.
#endif

// Specifies the font to be used for the OLED display.
